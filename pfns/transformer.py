...
class TransformerModel(nn.Module):
        ...
        def make_decoder_dict(decoder_description_dict):
            ...
            for decoder_key in decoder_description_dict:
                ...
                if decoder_model is None:
                    initialized_decoder_dict[decoder_key] = nn.Sequential(nn.Linear(ninp, nhid), nn.GELU(),
    ...
    def _forward(self, src, src_mask=None, single_eval_pos=None, only_return_standard_out=True):
        ...
        #print("called TransformerModel _forward")
        ...
        if single_eval_pos is None:
            #print("single_eval_pos is None, setting it to x_src.shape[0]")
        ...
        if self.decoder_dict_once is not None:
            #print("self.decoder_dict_once is not None, adding decoder_dict_once_embeddings to x_src")
        ...
        if self.style_encoder:
            #print("self.style_encoder is used, encoding style_src")
            ...
            #print("no style_encoder, setting style_src to empty tensor")
        ...
        if self.input_ln is not None:
            #print("applying input layer normalization")
        ...
        if self.return_all_outputs:
            #print("returning all outputs as requested")
            out_range_start = num_prefix_positions
        else:
            #print("returning only eval outputs")
